(() => {
        ...
        if (document.querySelector(".product-card__slider")) new core(".product-card__slider", {
            ...
            thumbs: {
                swiper: {
                    ...
                    spaceBetween: 10,
                    navigation: {
                        prevEl: ".product-card__subbutton-prev",
                        nextEl: ".product-card__subbutton-next"
                    }
                }
            }
        });
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        let time = 1200;
        const countDownEl = document.getElementById("countdpwn");
        if (countDownEl) {
            setInterval(upeateCountdown, 1e3);
            function upeateCountdown() {
                ...
                time--;
                if (minutes == 0 && seconds == 0) time = 1200;
            }
        }
    }));
    window["FLS"] = true;
